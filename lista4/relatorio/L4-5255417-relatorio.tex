...
\section{Matrix Operations}
    ...
    \subsection{Exerc\'icio 1}
        ...
        \end{figure}
        Com o resultado:
        \lstinputlisting{../images/L4-5255417-ex-1-results-2.txt}
        \begin{figure}[H]
            \centering
        ...
        \end{figure}
        Com o resultado:
        \lstinputlisting{../images/L4-5255417-ex-1-results-10.txt}
        \begin{figure}[H]
            \centering
        ...
        \end{figure}
        Com o resultado:
        \lstinputlisting{../images/L4-5255417-ex-1-results-100.txt}
        \begin{figure}[H]
            \centering
        ...
        \end{figure}
        Com o resultado:
        \lstinputlisting{../images/L4-5255417-ex-1-results-200.txt}
