!------------------------------------------------------------
! File: P2-5255417-ex-3b.f90
!
! Description:
!   Use the Householder modified method to tridiagonalize a matrix, find its largest and lowest eigenvalue/eigenvector using the Power Method, and check the solution.
!
! Dependencies:
!   - None
!
...
!------------------------------------------------------------
program TridiagonalizationModified
    ...
    !save yt max and min
    open(unit=1, file="At_eingenvector-b.txt", status="replace")
...
end program TridiagonalizationModified
