...
def plot_wavefunction():
    ...
    fortran_output_file = "P2-5255417-ex-2-results.txt"
    ...
    psi_theoretical = np.sqrt(2.0/L) * np.cos(np.pi * x_theoretical / 2.0 * L)

    # --- 4. Plotting ---
    # Plot the theoretical solution as a continuous red line.
    ax.plot(x_theoretical, psi_theoretical, 'r-', label='Theoretical Solution ($\sqrt{2}\cos(\pi x/2)$)', linewidth=2)
